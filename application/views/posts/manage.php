<div class="span12 content">
	<div>
		<h2>Update <?php echo $post->title;?></h2>
		...
		<div class="well">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<?php if ( ! empty($post->image)):?>
						<?php echo HTML::anchor("posts/manage_remove_image/{$post->random_string}", 'Remove Image', array('class' => 'confirmation'));?>
					<?php endif;?>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<div class="controls">
					<input type="submit" class="btn btn-large btn-primary span2" value="Update"/>
				</div>
			</div>
		...
		<div class="well">
			<div class="alert alert-danger">
				<button type="button" class="close" data-dismiss="alert">×</button>
				<h4>Warning!</h4>
				<p>This is a non-recoverable action. You won't be able to re-publish this after deletion.</p>
				<?php echo HTML::anchor("posts/manage_destroy/{$post->random_string}", 'I know what I\'m doing. Permanently Delete this Advertisement', array('class' => 'btn btn-danger confirmation'));?>
			</div>
		</div>
